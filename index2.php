...
<body class="demo-2">
	...
	</symbol></svg> <video autoplay="" loop="" muted><source src="2015-12-04-cave.webm" type="video/mp4"></video>
	<div class="overlay">
		<div class="language-container">
				<a class="language" id="language-fr" href="index.php">FR </a>
		...
		<div class="flex-title">
			<div class="sub-flex-title">
				<div class ="title-ctn-flex">
					...
					<p>Young students to service your projects at the lowest costs. </p>  <!-- Our favorite project? That's the next one. -->
					<div class="btt-a-ctn">
					<div class="btt-a">
						<a class="btt" target="_blank" href="img/Mamouth.pdf">Our expertise  </a>
					</div>
				</div>
...
<!--					<p>Chère Mamouth,</p>
						...
						<div class="test">
							<div>
								<p>Dear Mamouth,<br>
								My name is <input id="your-name" name="nom" placeholder="(your name)" required="" type="text"> <br> & </p>
							</div>	
							<div>
								<p>My email adress is <br> <input id="email" name="email" placeholder="(your email adress)," required="" type="email"></p>
								<p>My  message,<br> </p>
							</div>
							<div>
		...
		<div class="tabscontent__item">
			<div class="column" id="mamouth-text">
				<div class="txt">
					<h1 class="tile">ABOUT US</h1>
					<div class="IT">
						<h2 style="color:#ff764b; font-weight:normal">Who we are ?</h2>
						<p> Hello !
						We are a group of 4 students studying <a class="texte">IT engineering. </a>  Each day we are looking for new adventures, new experiences and new challenges, we want to develop our expertise in the field. 
						In this vision we have created <!-- <a class="texte"> --> Mamouth. <br> <br>
						Mamouth loans is professional services at lowest cost.
						It's win-win : an <a class="texte"> attractive price </a> for you and it's a <a class="texte"> gain experiences  </a>  for us. 
						Don't hesitate to contact us to talk about your project. it's with a big pleasure that we'll listen you and walk with you. <br> <br> 
						Look forward to meet you. <br>
						Team Mamouth. 
						</p>
					</div>
				</div>
